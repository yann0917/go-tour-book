...
var (
	ErrGetTagListFail = NewError(20010001, "获取标签列表失败")
	ErrCreateTagFail  = NewError(20010002, "创建标签失败")
	ErrUpdateTagFail  = NewError(20010003, "更新标签失败")
	ErrDelTagFail     = NewError(20010004, "删除标签失败")
	ErrCountTagFail   = NewError(20010005, "统计标签失败")
